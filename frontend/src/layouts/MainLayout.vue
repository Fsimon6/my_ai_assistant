  ...
  <div class="main-container">
    ...
    <el-header class="header">
      ...
      <div class="header-center">
        <!--
          :ellipsis="false" —— 横向菜单默认会在宽度不足时把**末尾项**折叠进"…"溢出菜单
          （悬停才展开）。这里显式关闭，保证「知识库」等主要入口始终与控制面板/AI角色/聊天
          同级、直接可见，不需要悬停三个点。
        -->
        <el-menu
...
.header {
  ...
  .header-center {
    ...
    // 关闭 ellipsis 后菜单项不再自动折叠，窄屏时改为"导航自身横向滚动"，
    // 避免把整页撑出横向滚动条（min-width:0 让 flex 子项可以被压缩）
    min-width: 0;
